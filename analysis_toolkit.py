...
def get_hfi_returns():
    ...
    hfi = pd.read_csv("data/edhec-hedgefundindices.csv",
                      header=0, index_col=0, parse_dates=True, date_format="%d/%m/%Y")
    hfi = hfi/100
...
def skewness(r):
    ...
    Computes the skewness of the given Series or DataFrame
...
def compound(r):
    """
    Returns the result of compounding a set of returns
